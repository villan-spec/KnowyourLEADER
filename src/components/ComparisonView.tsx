        ...
        <div>
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-[var(--color-accent-blue)]/8 flex items-center justify-center">
                        <Scale size={20} className="text-[var(--color-accent-blue)]" strokeWidth={1.8} />
                    </div>
                    <div>
                        <h2 className="text-xl font-semibold">{constituencyName}</h2>
            ...
            {/* Scale legend */}
            <div className="card p-3 mb-4 flex items-center justify-center gap-6 text-xs text-[var(--color-text-tertiary)]">
                <span>Metric rings are normalized to the same scale for fair comparison</span>
            </div>

            {/* Candidate cards grid */}
            <div
                className={`grid gap-5 ${candidates.length === 1
